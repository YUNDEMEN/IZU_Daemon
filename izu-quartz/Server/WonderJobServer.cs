...
public class WonderJobServer : IWonderJobServer
{
    private readonly ILogger<WonderJobServer> logger;
    private ISchedulerFactory schedulerFactory = null!;
    private IScheduler scheduler = null!;

    /// <summary>
    /// Initializes a new instance of the <see cref="WonderJobServer"/> class.
    /// </summary>
    public WonderJobServer()
    {
        logger = LogProvider.CreateLogger<WonderJobServer>();
    }

    /// <summary>
    /// Initializes the instance of the <see cref="WonderJobServer"/> class.
    /// </summary>
